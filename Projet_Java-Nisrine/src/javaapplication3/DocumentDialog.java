...
public class DocumentDialog extends JDialog {
    private RoundedTextField sujetField;
    ...
    public DocumentDialog(Frame parent, String title, String[] initialData) {
        ...
        mainPanel.add(new RoundedLabel("Sujet"), gbc);
        gbc.gridx = 1; gbc.gridy = 0;
        sujetField = new RoundedTextField(20);
        sujetField.setText(initialData != null ? initialData[1] : "");
        mainPanel.add(sujetField, gbc);

        // Encadrant
        gbc.gridx = 0; gbc.gridy = 1;
        mainPanel.add(new RoundedLabel("Encadrant"), gbc);
        gbc.gridx = 1; gbc.gridy = 1;
        encadrantField = new RoundedTextField(20);
        encadrantField.setText(initialData != null ? initialData[2] : "");
        mainPanel.add(encadrantField, gbc);

        // Auteur
        gbc.gridx = 0; gbc.gridy = 2;
        mainPanel.add(new RoundedLabel("Auteur"), gbc);
        gbc.gridx = 1; gbc.gridy = 2;
        auteurField = new RoundedTextField(20);
        auteurField.setText(initialData != null ? initialData[3] : "");
        mainPanel.add(auteurField, gbc);

        // Année
        gbc.gridx = 0; gbc.gridy = 3;
        mainPanel.add(new RoundedLabel("Année"), gbc);
        ...
        mainPanel.add(new RoundedLabel("Catégorie"), gbc);
