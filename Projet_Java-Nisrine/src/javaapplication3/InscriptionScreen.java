...
public class InscriptionScreen extends JPanel {
    public InscriptionScreen() {
        ...
        RoundedTextField emailField = new RoundedTextField(30);
        ...
        gbc.gridx = 1; RoundedTextField nomField = new RoundedTextField(20); styleInputField(nomField); formPanel.add(nomField, gbc);
        gbc.gridx = 2; formPanel.add(createStyledLabel("Prénom :"), gbc);
        gbc.gridx = 3; RoundedTextField prenomField = new RoundedTextField(20); styleInputField(prenomField); formPanel.add(prenomField, gbc);

        gbc.gridy++;
        gbc.gridx = 0; formPanel.add(createStyledLabel("CNE :"), gbc);
        gbc.gridx = 1; RoundedTextField cneField = new RoundedTextField(20); styleInputField(cneField); formPanel.add(cneField, gbc);
        gbc.gridx = 2; formPanel.add(createStyledLabel("CIN :"), gbc);
        gbc.gridx = 3; RoundedTextField cinField = new RoundedTextField(20); styleInputField(cinField); formPanel.add(cinField, gbc);
        ...
        gbc.gridx = 3;
        JComboBox<String> filiereBox = new JComboBox<>(new String[]{"Mathématiques", "Informatique", "Physique","Chimie", "Géologie", "Biologie", "Enseignements transversaux"});
        formPanel.add(filiereBox, gbc);

        gbc.gridy++;
        gbc.gridx = 0; formPanel.add(createStyledLabel("Mot de passe :"), gbc);
        gbc.gridx = 1; RoundedPasswordField passField = new RoundedPasswordField(20); styleInputField(passField); formPanel.add(passField, gbc);
        gbc.gridx = 2; formPanel.add(createStyledLabel("Confirmer mot de passe :"), gbc);
        gbc.gridx = 3; RoundedPasswordField confirmPassField = new RoundedPasswordField(20); styleInputField(confirmPassField); formPanel.add(confirmPassField, gbc);
...
Timer checkResponseTimer = new Timer(4000, e -> {
    try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/unilib", "root", "")) {
        ...
        gbc.gridy++;
        JLabel backToHomeLabel = new JLabel("← Retour à l'accueil");
        backToHomeLabel.setForeground(Color.BLUE);
        backToHomeLabel.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        backToHomeLabel.setFont(new Font("Arial", Font.PLAIN, 14));

        backToHomeLabel.addMouseListener(new java.awt.event.MouseAdapter() {
            @Override
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Window window = SwingUtilities.getWindowAncestor(InscriptionScreen.this);
        ...
        JPanel homeLinkPanel = new JPanel(new FlowLayout(FlowLayout.CENTER, 0, 0));
        homeLinkPanel.setOpaque(false);
        homeLinkPanel.add(backToHomeLabel);
        formPanel.add(homeLinkPanel, gbc);
