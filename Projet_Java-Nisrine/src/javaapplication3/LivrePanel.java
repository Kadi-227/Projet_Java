...
public class LivrePanel extends RoundedPanel {
    ...
    private void initializeDatabaseConnection() {
        try {
            String url = "jdbc:mysql://localhost:3306/unilib";
            String user = "root";
            String password = "";
    ...
    private void addLivreItem(String numInventaire, String titre, String auteur, String nbrExemplaires, String categorie, String cote, String imagePath) {
        ...
        RoundedLabel titleLabel = new RoundedLabel("Titre");
        ...
        RoundedLabel nbrLabel = new RoundedLabel("Nombre d'exemplaires");
        nbrLabel.setFont(new Font("Segoe UI", Font.BOLD, 12));
        detailsPanel.add(nbrLabel, gbc);
        gbc.gridx = 1; gbc.gridwidth = GridBagConstraints.REMAINDER;
        RoundedLabel nbrValue = new RoundedLabel(nbrExemplaires);
        nbrValue.setFont(new Font("Segoe UI", Font.PLAIN, 12));
        detailsPanel.add(nbrValue, gbc);

        gbc.gridx = 0; gbc.gridy = 3; gbc.gridwidth = 1;
       RoundedLabel categorieLabel = new RoundedLabel("Catégorie");
        ...
        RoundedLabel coteLabel = new RoundedLabel("Côté");
        coteLabel.setFont(new Font("Segoe UI", Font.BOLD, 12));
        detailsPanel.add(coteLabel, gbc);
        gbc.gridx = 1; gbc.gridwidth = GridBagConstraints.REMAINDER;
        RoundedLabel coteValue = new RoundedLabel(cote);
        ...
        RoundedButton editButton = new RoundedButton(new ImageIcon(getClass().getResource("/icons/edit.png")));
        ...
        RoundedButton deleteButton = new RoundedButton(new ImageIcon(getClass().getResource("/icons/garbage.png")));
...
class EditLivreFrame extends JFrame {
    ...
    private RoundedTextField nbrExemplairesField;
    private JComboBox<String> categorieCombo;
    private RoundedTextField coteField;
    private RoundedLabel imageLabel;
    ...
    public EditLivreFrame(String[] livre) {
        ...
        gbc.gridx = 1;
        titreField = new RoundedTextField(livre != null ? livre[1] : "", 20);
        ...
        gbc.gridx = 1;
        auteurField = new RoundedTextField(livre != null ? livre[2] : "", 20);
        ...
        gbc.gridx = 1;
        nbrExemplairesField = new RoundedTextField(livre != null ? livre[3] : "", 20);
        ...
        gbc.gridx = 1;
        coteField = new RoundedTextField(livre != null ? livre[5] : "", 20);
        ...
        RoundedButton changeImageButton = new RoundedButton("Changer Image");
