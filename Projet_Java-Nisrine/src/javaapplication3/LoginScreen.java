...
public class LoginScreen extends JPanel {
    public LoginScreen() {
        ...
        // Login
        gbc.gridy = 0;
        RoundedLabel userLabel = createStyledLabel("Email :");
        ...
        // Password
        gbc.gridy++;
        RoundedLabel passLabel = createStyledLabel("Mot de passe :");
        ...
        // Error Label
        gbc.gridy++;
        RoundedLabel errorLabel = new RoundedLabel("");
        ...
        backToHomeLabel.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                Window window = SwingUtilities.getWindowAncestor(LoginScreen.this);
        ...
        gbc.gridy++;
        formPanel.add(backToHomeLabel, gbc);
    ...
    private boolean checkCredentials(String login, String password) {
        try {
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/unilib", "root", "");
    ...
    private RoundedLabel createStyledLabel(String text) {
